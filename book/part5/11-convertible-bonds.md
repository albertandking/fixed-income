...
可转债是固定收益中颇具特色的品种：它本质是一只债券，又内嵌一份**把债券转换成股票的权利**。正股上涨时它表现出股票的特征（跟随正股上涨），正股下跌时则表现出债券的特征（有纯债价值托底）——即"下有保底、上不封顶"，这种**非对称收益**使其成为攻守兼备的资产。

这一特性背后是定价的复杂性：可转债价值同时取决于**利率**（债的一面）与**股价、股票波动率**（股的一面），并叠加赎回、回售、下修等多重条款博弈。第10章以利率树为含权债定价；本章将工具换为**股票二叉树**，并阐明"债性"与"股性"之间的切换。可转债是 Part 5 的收尾，也是连接固定收益与权益的桥梁。
...
!!! note "中国可转债的标准条款"
    中国可转债高度标准化：转股期通常自发行 6 个月后开始；**强赎线 130%、回售线 70%、15/30 个交易日**是典型阈值；几乎都含**下修条款**。正因条款统一，中国可转债成为研究嵌入期权博弈的良好样本——投资者博弈的并非利率，而是**发行人"促转股"的强烈动机**（多数发行人倾向于促成转股，而非到期还本）。
