...
前八章的债券，票息都是**固定**的——发行时定好，到期不变。但利率会变：买了一只固定票息 3% 的债，若市场利率涨到 5%，你的债就显得"票息太低"、价格大跌（第6章的利率风险）。**浮动利率债券（Floating Rate Note, FRN）**给出了另一种思路：**让票息随市场利率一起浮动**——市场利率涨，下一期票息也涨。如此一来，债券价格几乎不随基准利率波动，利率风险被大幅削弱。
...
!!! tip "把浮息债想成"短债的滚动""
    持有一只浮息债，近似等于"不断滚动持有一只到下次重定价的短债"。所以它的利率敏感度像短债（很低），但信用暴露像长债（一直持有到期）。这个"利率短、信用长"的二重性，是理解浮息债风险的钥匙。
...
直觉：若市场如今要求的利差（DM）高于这只债支付的利差（QM）——比如发行人信用恶化了——投资者只愿以**折价**买入，用价格折让补足"利差不够"的部分。
