...
浮息债不是金融工程师在书桌前凭空设计出来的，它是被通胀逼出来的。20 世纪 70 年代欧美深陷高通胀，市场利率一路飙升，那些早年买入固定低票息长债的投资者眼睁睁看着自己的债券在通胀里贬值、价格腰斩——锁定的票息成了诅咒。正是在这种背景下，浮息债登上舞台：它把"票息固定"这个在通胀年代最危险的特征拆掉，换成"票息跟着市场走"，让投资者不再为加息提心吊胆。理解了这段出身，就抓住了浮息债的灵魂——**它的全部设计，都是为了把利率风险从投资者肩上卸下来**。
...
这里值得停下来体会 QM 与 DM 分道扬镳的过程，因为它正是浮息债"利率风险低、信用风险不低"的全部秘密所在。发行那天，市场觉得这家公司值 +50bp 的补偿，于是把 QM 钉死在 50bp、债券平价发行，此刻 DM=QM。一年后，公司经营恶化、评级下调，市场认为现在要 +120bp 才肯持有它——但 QM 是合同、改不了，它仍然只付 +50bp。多出来的 70bp 缺口怎么补？只能靠**价格下跌**：债券跌到某个折价，让"少付的利差"被"买得便宜"抵平，算下来的实际利差（DM）才重新等于市场要求的 120bp。所以浮息债的价格波动，几乎全部来自 **DM 的变动，也就是市场对这家发行人信用看法的变动**——基准利率涨跌早被重定价机制吸收掉了。这就是为什么分析一只信用浮息债，老练的交易员盯的从来不是它的票息或 YTM，而是**DM 相对 QM 走阔了还是收窄了**：那是市场信用判断的温度计。
...
浮息债把"利率风险"换成了"利差风险"，但并非毫无风险。还有一类风险常被忽略，却足以撼动整个市场——**基准本身的风险**。浮息债把命运拴在了一个基准利率上，可这个基准是谁、怎么报出来的、可不可信，本身就是一个问题。2012 年爆发的 **LIBOR 操纵丑闻**就是惨痛一课：作为全球数百万亿美元浮息合约锚定的基准，LIBOR 竟是少数大行每天"报"出来、而非真实成交出来的，多家银行被揭发串通操纵报价。这场信任危机直接导致 LIBOR 被逐步废弃，全球在 2021—2023 年间艰难地把基准切换到基于真实回购成交的 **SOFR**——一次牵动无数存量浮息债、互换合约重新锚定的"利率界换心手术"。中国市场亦有自己的基准演进脉络：浮息债的锚从早年的一年期定存利率，逐步转向 **SHIBOR**，再到 2019 年 LPR 改革后越来越多地挂钩 **LPR**——每一次换锚，都在重塑浮息债票息的来源。**选择什么基准，从来不是技术细节，而是决定了你的票息建立在多坚实的地基之上。**
