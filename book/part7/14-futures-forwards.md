...
!!! note "本章知识结构"
    **国债期货合约**（14.2，名义标准券 + 一篮子可交割券、保证金、交割）
    　↓ 多只券怎么折算、交割哪只
    **转换因子 + 最便宜可交割券 CTD**（14.3，毛基差最小）
    　↓ 期货敏感度由 CTD 决定
    **基差与 DV01 中性套保**（14.4，期货 DV01 ≈ CTD DV01/CF）
    　↓ 锁定未来利率
    **远期利率协议 FRA**（14.5）→ 用国债期货对冲组合久期（14.8）
...
为什么国债期货的出现，是利率风险管理的一次"革命"？设想一家保险公司看空债市、想把组合久期砍掉一半。在没有期货的年代，它只能**真刀真枪地抛售现券**——卖出几十亿元的国债，不仅要支付高昂的买卖价差和冲击成本，还会惊动市场、压低自己手里其余持仓的价格，更别提卖出后这笔钱还得重新找地方安放。而有了国债期货，它只需缴纳一笔**几个百分点的保证金**、卖出相应数量的期货合约，几分钟内就能把组合久期调到目标，现券则原封不动地躺在账上。**同样是改变利率敞口，前者是搬动整座货仓，后者只是拨动一个旋钮。** 这种"用小额保证金、高流动性的标准合约，撬动大额利率敞口调整"的能力，让利率风险管理从"重资产"一跃进入"轻资本"时代——对冲、久期择时、套利都因此变得灵活而廉价。这也是为什么中金所国债期货上市后迅速成为中国机构管理利率风险的核心工具。
...
值得点破的是：CTD 机制的背后，其实又是一份**期权**——只不过这次持有者是期货空头。合约允许空头在交割时"从一篮子券里挑一只来交"，而理性的空头永远会挑对自己最划算（交割成本最低）的那只。**"能从多个选项里挑最优"这件事本身就是一种选择权**，金融上称为空头的"**交割期权（delivery option）**"或"质量期权（quality option）"。这解释了一个看似奇怪的现象：国债期货的价格，总是比"直接按 CTD 折算"应有的价格略低一点点——因为多头知道自己会被交付那只对空头最有利、对自己最不利的券，于是要求一点价格折让作为补偿，这点折让正是交割期权的价值。本书的 CTD 分析用静态的毛基差近似抓住了主线，但请记住这层期权色彩：它和第10章可赎回债、第11章可转债是同一个母题的变奏——**只要合约里有一方握着"选择权"，定价里就一定藏着一份期权的价值**。这也是为什么 CTD 会随利率和曲线形状"切换"：选择权的最优行权对象，本就会随市场环境而变。
...
!!! note "关键公式速查"
    | 概念 | 公式 |
    |---|---|
    | 转换因子 | CF = 以名义票息(3%)定价的每元面值净价 |
    | 发票价格 | 期货价格 × CF + 应计利息 |
    | 毛基差 | 现券净价 − 期货价 × CF；CTD = 毛基差最小 |
