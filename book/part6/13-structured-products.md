...
理清这层关系，MBS 的风险结构便清晰可辨：**每一个房贷借款人都持有一份提前还款期权**，而 MBS 投资者即为这份期权的卖方。这与第10章可赎回债中"投资者向发行人卖出赎回权"属于同一机制，只是行权方由企业变为众多购房者。利率下行时，借款人如同可赎回债的发行人一般行权——将高息旧贷提前结清、再融入利率更低的新贷，本金随之提前回流至 MBS 投资者，而投资者只能将这笔资金再投资于当下利率更低的资产（**收缩风险**）。利率上行时，借款人则倾向于延后偿还，MBS 的久期被动拉长，恰逢利率上行、最不利于久期延长之时（**延展风险**）。两种情形均对投资者不利——这正是第6章所述"负凸性"的再现：利率下行时价格上行空间受限（本金被提前偿还），利率上行时久期又难以缩短（提前还款放缓）。由此可见，MBS 投资者所获的额外利差，与可赎回债的较高票息同理，本质上是为卖出这份借款人期权所收取的权利金。
...
!!! success "编程实验 7–9（要点）"
    - **实验 7**：`fi.securitization` 复现例13.1；图13-1 阶梯图——次级先打穿（0–5%）、再夹层（5–20%）、优先在 20% 后才受损。
