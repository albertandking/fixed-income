...
这里发生的事情，乍看像一场点石成金的魔术：底层是一池子信用一般、违约率不低的资产（比如次级房贷、消费贷），经过分层这道工序，竟能切出一块评级 AAA、堪比国债的优先档来。**资质平平的原料，怎么就产出了顶级证券？** 魔术的机关全在"谁先挨打"。把资产池的损失想象成从楼底往上灌的水：水（损失）先淹没站在最底层的次级档，次级被淹没了才轮到中间的夹层，夹层也满了才漫到顶层的优先档。于是只要"水位"（总损失）不超过次级加夹层的高度，站在顶楼的优先档**连鞋都不会湿**。换句话说，优先档的 AAA 不是凭空变出来的，而是**次级档用自己'先死'的承诺换来的**——次级投资者明知自己第一个承担损失，却为何还愿意买？因为他们站在瀑布的最末端，一旦资产池表现良好、损失没吃光他们这一层，剩下的超额收益也全归他们，是"高风险高回报"的赌注。所以分层的本质，是把同一池现金流按"挨打顺序"重新切割，**让偏好安全的人买优先档、偏好博收益的人买次级档，各取所需**。但请记住魔术师永远不会告诉你的那句话：分层只是重新分配了损失，**它一点也没有减少资产池的总损失**——这正是 13.5 节那记 2008 年警钟的伏笔。
...
把这层关系说透，MBS 的全部风险就豁然开朗了：**每一个房贷借款人，手里都攥着一份免费的"提前还款期权"**，而买 MBS 的投资者，就是这份期权的卖方。这和第10章可赎回债里"投资者卖给发行人赎回权"是同一个剧本，只不过行权方从企业换成了千千万万的购房者。利率一降，借款人就像可赎回债的发行人那样行权——把高息旧贷提前结清、再融一笔便宜的新贷，于是本金哗哗回流到 MBS 投资者手上，可投资者只能拿着这笔钱去买如今更低利率的资产（**收缩风险**）。利率一升，借款人则反其道而行、能拖就拖着不还，MBS 的久期被动地越拉越长，偏偏卡在利率上行、最不该久期变长的时候（**延展风险**）。两头都对投资者不利——这正是第6章那个"负凸性"的活生生再现：**该涨的时候涨不动（本金被提前还掉），该短的时候短不了（没人愿意提前还）**。所以 MBS 投资者收到的那一点额外利差，本质和可赎回债的高票息一样，是为卖出这份"借款人期权"所收的权利金。
