...
!!! note "本章知识结构"
    ...
    **被动管理**（17.3，买入持有 / 分层抽样复制指数、跟踪误差）
    　↓ 检验与拆解
    **回测框架 + 收益归因**（17.4，carry + roll-down + 久期 + 凸性；beta vs alpha）
    　↓
    `fi.backtest` 实现（17.5）→ 中国债券投资实践（17.6）
...
对利率方向下注：**看多债市（预期利率下行）→ 拉长组合久期**（放大价格上涨）；**看空 → 缩短久期**。久期是表达利率观点的总开关，可用现券、国债期货（第11章）或互换（第12章）快速调整。

### 17.2.2 骑乘曲线（riding / rolling down the yield curve）

**当收益率曲线向上倾斜且预期不变时**，买入期限长于投资期的债券，持有一段后卖出：债券随时间"变短"，沿曲线**下滚**到更低的收益率点，收益率下降带来价格上涨（**roll-down 收益**），叠加票息（**carry**），总收益高于直接持有短债。这是债券投资中最为经典、稳健的策略之一，其收益无需主动预测利率即可获取。

骑乘曲线一个值得注意的特点是：**它无需投资者主动预测利率，只要时间推移、曲线维持原状，收益便会自然产生。** 可将收益率曲线设想为一道向上的斜坡，投资者买入的 5 年期债券对应坡上一个较高的点（收益率较高）。一年之后，它自动变为 4 年期债——只要整条曲线未动，4 年期对应的收益率本就比 5 年期低，于是该债券的收益率沿斜坡下滑了一格，而收益率下降即意味着价格上涨。**投资者并未进行任何操作，仅是让债券随时间沿斜坡下滚，资本利得便随之产生**，这正是"roll-down"（下滑）一词的由来；再叠加持有期内收取的票息（carry），总回报自然高于直接持有短债。值得注意的是，这一收益附有一个前提条件：**曲线须大致保持不变**。一旦曲线整体大幅上移（利率普涨），下滑带来的资本利得将被价格下跌所吞没——由此可见，它并非"免费的午餐"，而是"曲线向上倾斜 + 时间流逝 + 曲线稳定"三者叠加所给出的、不依赖预测的结构性收益。这也是 17.4 节的收益归因要专门将其从"依靠预测获取的收益"中分离出来的原因。
...
在利率债之外赚**信用/品种利差**：信用下沉（买低评级博利差）、骑乘信用利差曲线、国开—国债利差交易等。收益更高，但承担信用风险（第14章）。
...
归因将"收益总量"拆解为"源于 carry/roll-down 的被动收益"与"源于择时的主动收益"，是评价策略的关键。

这一拆解之所以重要，是因为**总收益数字可能掩盖收益来源的差异，而归因则能将其显现**。假设两位基金经理本年度均取得 5% 的收益，仅从账面难分高下。但分解来看：第一位的 5% 几乎全部来自 carry 与 roll-down——换言之，他仅是买入持有、收取票息，市场对所有参与者给出的收益大致相同，这部分称为 **beta**（市场整体回报，所有投资者均可获得）；第二位的 5% 中有 3% 来自 carry/roll-down，另外 2% 来自他准确判断利率下行、主动拉长久期所获得的收益——这 2% 才是真正考验判断力、他人未必能够复制的 **alpha**（超额管理能力）。**前者源于市场的整体回报，后者源于主动管理能力**；若仅观察"二者均取得 5%"，则可能将受益于行情者误判为具备能力者，而将真正有能力者混同于平庸。收益归因正是用于甄别收益来源的工具，它要求我们回答一个必要的问题：**该收益究竟源于市场整体，还是源于主动管理能力？** 对投资者而言，它决定应为哪种业绩支付管理费；对基金经理自身而言，它是区分"确具能力"与"仅是恰逢行情"的关键依据。
...
!!! note "知识点自测清单"
    - [ ] 解释**骑乘曲线**为何不预测利率也能获超额收益，及其前提与风险
    - [ ] 把债券收益分解为 **carry + roll-down + 久期 + 凸性**，分辨 beta 与 alpha
