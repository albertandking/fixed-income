...
VaR 之所以被风控界广泛采用、成为董事会与监管者共同的沟通语言，是因为它把"这个庞杂组合究竟有多危险"这一难以把握的问题，浓缩为**一个数字**："我们有 99% 的把握，明天最多亏 580 万。"管理者无须深究久期与凸性，仅凭这一数额即可对组合的风险水平形成判断。然而，这种"以单一数字概括全局"的简洁，也潜藏着 VaR 最关键的局限——**它只标明了门槛所在，却未对门槛之外的损失加以说明。** "99% 的日子亏不超过 580 万"这一表述，对其余 **1% 的日子**并无交代：那一天可能亏 600 万，也可能亏 6000 万，VaR 对此并不区分。值得注意的是，依据历史数据估出的"平静期 VaR"往往偏小，机构据此放心加杠杆，直至那 1% 的尾部真正降临——2008 年金融危机中，许多机构的 VaR 模型在危机来临前仍显示"风险可控"，其后即被远超模型预期的损失所击穿。**由此可见，VaR 给出的是一种虚假的安全感，而真正造成重大损失的，恰恰是它按定义不予考察的那 1%。** 这正是下一节 CVaR 所要弥补的缺口，也是阅读本章时须始终留意之处：风险度量本身，亦可能成为风险的来源。
...
可借一个比喻把握二者的分工：**VaR 如同悬崖边的一道护栏，标明"栏杆设在离崖边几米处"；CVaR 则说明"一旦越过栏杆，崖下有多深"。** 护栏设置得再标准，也不改变其脚下究竟是低矮土坡还是高耸崖壁——对一个潜在损失可能很大的组合而言，崖下的深度比护栏的位置更为重要。两个组合可以有完全相同的 VaR（护栏位置相同），尾部的"崖下深度"却可能相差悬殊：一个突破阈值后平均仅多亏少许，另一个突破后则可能损失殆尽。CVaR 将这一被 VaR 略去的"尾部深度"重新纳入考量，这正是它在风险管理上更为可靠的根本原因。

CVaR 还有一项理论优势——它是**一致性风险度量（coherent）**，满足**次可加性**（组合的风险不超过各部分之和），而 VaR 不满足。次可加性换言之即"**分散化不应使风险变大**"——把两个资产纳入同一组合，整体风险至多等于各自风险之和、通常还更小，这是"不要把鸡蛋放在同一个篮子里"这一基本直觉的数学表达。然而 VaR 在某些情形下会**违反**这一常识：两个资产合并后的 VaR 反而大于二者 VaR 之和，相当于断言"分散化使风险增大"——这显然不合理，并可能诱导出"拆分持仓以粉饰风险"的扭曲行为。CVaR 不存在这一问题，它对分散化的处理始终一致。正因为既能反映尾部深度、又在数学上自洽，巴塞尔新规（FRTB）已从 VaR 转向 **ES** 作为市场风险资本的基础——这是监管层通过资本要求，确立"度量风险须正视尾部"这一原则的体现。
...
- **中国**：金融监管总局、央行的资本充足率、流动性、杠杆率（第16章）等监管，以及债券投资的久期/集中度/杠杆限额。
