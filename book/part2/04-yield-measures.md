...
为什么市场如此偏爱 YTM 这个数字？走进任何一家机构的交易室，行情屏幕上跳动的主角从来不是价格，而是**收益率**——因为价格被票息、面值、剩余期限搅在一起，两只债的价格高低根本没法直接比，而 YTM 把这一切**压缩成一个统一口径的年化回报率**，让一只 3 年票息 2% 的债和一只 10 年票息 4% 的债能放在同一把尺子上量。从这个角度看，YTM 是市场为异质的债券发明的"普通话"。但要时刻记住它的另一面：YTM 是一个**条件式**的收益率——它回答的是"**如果**我持有到期、**并且**每一笔票息都能按这个 $y$ 再投资，我的年化回报才是 $y$"。这个"如果"在现实中往往不成立（4.4 节会量化），所以 YTM 更像一个用于**比较和报价**的标尺，而非对未来收益的承诺。
...
"今天就能锁定未来的利率"听起来像魔法，其实只需要现成的零息债就能做到。假设你想锁定"一年后开始、为期一年"的借款利率：今天**借入**一笔一年期资金、同时把它**投出**两年期，到第一年末借的钱要还、投的钱还在滚——你已经凭空构造出一笔"从第 1 年末到第 2 年末"的资金安排，其成本就是上式算出的 $f(1,2)$。正因为任何人都能用即期债**复制**出远期，远期利率才不能随意定价：一旦它偏离无套利值，套利者立刻能用即期债组合"无本生利"，把它拉回原位。所以远期利率不是谁的主观预测，而是**今天的即期曲线在逻辑上被迫吐出的未来利率**。

这也带出一个常见误区：远期利率**不等于**市场对未来利率的真实预期。二者之间隔着一层**期限溢价**——投资者锁定长期通常要额外补偿，所以即使市场预期未来短期利率不变，向上倾斜的即期曲线也会让远期利率高于当前短端。把远期利率直接当成"市场认为一年后利率会涨到这"，是宏观解读里最容易踩的坑。
...
把它放到一个具体的人身上更刺痛：一位退休者在 2018 年买入一只 10 年期、票息 4% 的债，盘算着"每年 4%、十年安稳"。可此后市场利率一路下行，他每年收到的票息再拿去投资，只能买到 3%、2% 的新债——十年下来，那些"被迫低息再投资"的票息利滚利的速度远低于当初设想，**最终到手的年化回报明显够不到 4%**。他没看错 YTM，他只是忽略了 YTM 藏在脚注里的那句"票息须按 4% 再投资"。再投资风险的隐蔽之处正在于此：它不像价格下跌那样当场可见，而是**在每一次票息到账、寻找去处时悄悄发生**，期限越长、票息越高，被这个假设主导的财富比例就越大。
