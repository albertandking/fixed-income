...
主动投资追求超额收益，但很多机构的首要目标不是"赚得多"，而是"**到期一定付得出**"：保险公司要在未来若干年兑付保单，养老金要按月发放退休金。对它们而言，风险的定义不是收益波动，而是**资产不足以覆盖负债**。负债驱动投资（LDI）因此把负债当作"基准"，让资产去**匹配**它的现值与利率敏感度。这是一个视角的根本翻转：普通基金经理盯着"我跑赢大盘了吗"，而 LDI 经理盯着的是"我的资产久期和负债久期对齐了吗"——后者眼里的头号敌人不是收益落后，而是**资产与负债对利率的敏感度不一致所撕开的缺口**。

这件事做不好，后果可以是系统性的。2022 年秋，英国国债收益率因一份激进的"迷你预算"在几天内飙升，把当地养老金普遍采用的 **LDI 策略**推到了崩溃边缘：这些基金为了用有限资金匹配超长期负债的久期，大量使用了**加杠杆的利率衍生品**；利率一暴涨，衍生品头寸瞬间产生巨额追加保证金要求，基金被迫**抛售国债换现金**，而抛售又进一步推高收益率、引发更多保证金催缴——一个自我强化的"死亡螺旋"。最终英格兰银行紧急入场购债才稳住局面。这场风波是 LDI 思想的一记警钟：**匹配久期的方向是对的，但用杠杆去匹配，会把利率波动放大成流动性危机**。回到中国语境，寿险公司则长期面临另一种 LDI 困境——**资产久期短于负债久期**（市场缺乏足够长的资产去匹配几十年的保单负债），利率持续下行时，到期资产只能以更低收益率再投资，埋下"利差损"的隐患。无论英国的杠杆螺旋还是中国的久期缺口，根子都是同一句话：**资产与负债的利率敏感度没对齐。** 本章要讲的免疫，正是对齐它的基本功。
...
为什么偏偏是"久期=持有期"这个点上抵消，而不是别的久期？换一个数学视角就一目了然。把 $H$ 时点的终值写成 $W(y)=P(y)\times(1+y)^{H}$——前一项是债券在 $H$ 时的价格（随 $y$ 上升而下降），后一项是把早期票息复利滚到 $H$ 的再投资因子（随 $y$ 上升而上升）。要让 $W$ 对利率不敏感，就令 $\frac{dW}{dy}=0$；代入价格对 $y$ 的导数正比于 $-D\cdot P$（修正久期的定义），整理后那个让两股相反力量恰好平衡的条件，**解出来正是麦考利久期 $=H$**。所以"久期=持有期"不是一条需要死记的口诀，而是"价格下跌的速度"与"再投资上升的速度"在 $H$ 点打平时数学上必然落到的位置。再换**经济视角**看：久期短于 $H$，组合"太快变现"、再投资风险主导，怕利率下行；久期长于 $H$，组合"压得太久"、价格风险主导，怕利率上行；**唯有久期恰好等于 $H$，组合在该时点对利率两个方向都"既不怕涨也不怕跌"**。
...
这里的哲学和免疫截然不同。免疫是一种**统计意义上的对冲**：它用久期这个"平均量"让财富对利率变动一阶免疫，但要持续盯盘、不断再平衡，本质是"用动态调整换取灵活与低成本"。现金流匹配则是一种**物理意义上的对应**：第 3 年要付 100，我就买一只第 3 年恰好回款 100 的债，钱和账**一一锁死**、严丝合缝。锁死之后利率天翻地覆都与我无关——因为我从不需要在中途卖出资产（没有价格风险），也从不需要把现金再投出去（没有再投资风险），两大风险被直接**斩断在源头**，而非像免疫那样让它们"相互抵消"。正因如此，现金流匹配在那些"一分钱都不能差、且负债时点完全确定"的场景里无可替代：比如法院判决的**结构化赔付**、锁定到期日的**专项养老金**。代价是它把自己绑得很死——可选券必须在恰当的期限上有恰当的现金流，约束一多，成本自然比灵活的免疫更高。**免疫是"对冲掉"风险，现金流匹配是"绕开"风险**，这是理解 7.4.3 那张取舍表的总纲。
