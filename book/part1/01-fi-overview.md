...
本章进入固定收益证券的学习。如果说股票对应"分享企业成长的不确定收益"，那么债券对应的则是"事先约定的现金流"。正是这种确定性，使债券市场成为现代金融体系的基础性环节：政府和企业在这里融资，全社会的利率在这里定价，货币政策从这里传导到实体经济。本章先对全局作概览——固定收益市场是什么、在中国如何组织、由谁监管、利率体系如何运转——再说明 Python 环境的搭建，并画出本书的第一张收益率曲线。
...
本节先界定固定收益市场，再说明其在中国金融体系中的核心功能与"贷款主导"背景。
...
| **流动性管理** | 机构通过回购、货币市场工具调剂短期头寸（第16章） |
| **货币政策传导** | 央行通过公开市场操作影响债市利率，再传导到信贷与实体经济 |

"定价基准"看似抽象，实则与普通人的经济生活密切相关。居民申请房贷时，银行报出的利率为"LPR 加点"；而 LPR 又锚定央行的政策利率，与国债收益率密切联动。换言之，十年期国债收益率的变动，最终会沿着这条链条传导至千万家庭每月的月供。在估值层面，股票分析师对一家公司估值时，需将未来现金流以"无风险利率 + 风险溢价"折现，其中的无风险利率即取自国债收益率；保险公司为保单定价、理财产品向客户报出预期收益，同样以国债曲线为锚。可以这样理解：国债收益率曲线相当于整个金融市场的基准标高，其水平的变动会引致各类资产定价的相应调整。正因如此，本书专辟一章（第5章）构建这条曲线，"读懂收益率曲线"也成为固收从业者的核心能力。

!!! note "为什么学固收要从“基准”二字理解"
    国债收益率曲线被称为"金融市场的标尺"。任何带风险的资产，其要求回报都可拆成"无风险利率 + 风险溢价"。学好固定收益，本质是学会读懂并使用这把标尺。

### 1.2.3 直接融资与中国的"贷款主导"特征
...
!!! warning "误区：债券 = 无风险？"
    初学者常把"固定收益"误读为"保本保收益"。**这是错的。** "固定"指的是现金流的**约定方式**（事先约定金额与时点），不是"没有风险"。即便是国债，价格也会随利率波动（**利率风险**，第6章）；信用债还面临**违约风险**（第14章）。把"固定收益"理解成"收益确定"，是固收投资亏损的第一来源。
...
- **票面利率与付息方式**：固定利率、浮动利率（基准 + 利差，第8章）、零息（贴现发行）；付息频率有按年、按半年、按季。
- **到期期限**：短期（≤1 年）、中期（1–10 年）、长期（>10 年）。

### 1.3.2 现金流特征

- **现金流的确定性**：理论上无违约时，利息与本金事先确定；实践中受**嵌入期权**（可赎回/可转，第9–10章）与**信用风险**（第14章）影响。
- **现金流的分布模式**：
    - **子弹型**：到期一次还本，期间付息（最常见）；
    - **分期偿还型**：到期前分期还本（如 MBS/ABS，第15章）；
    - **年金型**：每期等额本息。
...
- **主要风险**：利率风险（价格与利率反向，第6章）、信用风险（第14章）、流动性风险、购买力（通胀）风险、再投资风险（第4章）。
...
利率债与信用债的收益率之差，就是**信用利差（credit spread）**——它是市场对违约风险与流动性差异的定价，也是信用债投资的核心收益与风险来源（第14章）。一个有趣的中间地带是**国开债（政策性金融债）**：它几乎无信用风险，却因税收待遇与流动性差异，收益率系统性高于同期限国债，二者之差（"国开—国债利差"）本身就是一个被广泛交易的标的（第3章案例）。

### 1.4.3 按计息方式划分

固定利率债、浮动利率债（第8章）、零息（贴现）债。
...
- **2014 年**"11 超日债"成为公募债首单实质性违约，**打破刚性兑付**，信用风险定价开始真正发挥作用（第14章）；
- **2017 年**"债券通"（北向通）开通，境外机构可经香港便捷投资内地债市，对外开放提速；
- 此后中国国债被纳入彭博巴克莱、摩根大通、富时罗素等主要国际债券指数，外资配置持续增加。

在这条时间线中，**2014 年的"11 超日债"值得单独说明**，因为它是中国信用债市场的标志性事件。在此之前，中国公募债券长期存在一种隐性惯例——**刚性兑付**：即便发行人经营陷入困境，地方政府或主承销商往往也会出面兜底，使投资者收回本息。这种隐性担保使信用债收益率的高低主要反映流动性差异，而非真实信用资质，违约风险在定价中被系统性忽视。超日太阳能未能按期支付利息且无人代偿的违约，使公募债投资者首次实际承担了本息损失，刚性兑付的预期由此开始改变。需要指出的是，这一事件的意义远超单只债券的盈亏：**它使"信用利差"首次真正反映违约概率**，市场开始为不同信用资质的发行人给出不同定价。第14章的全部信用定价工具，也正是以"刚性兑付被打破"为前提才具备现实意义。
...
| | 中期借贷便利（MLF） | 投放中期流动性 |
| **市场基准** | DR007 / R007 | 银行间质押回购利率，资金面指标（第16章） |
| | SHIBOR | 上海银行间同业拆放利率 |
...
利率走廊的设计较为精巧，而其必要性可由一次真实的市场波动加以说明。2013 年 6 月，中国银行间市场出现了被称为"**钱荒**"的事件：在多重因素叠加下，银行间隔夜回购利率盘中一度升至接近 **30%**，而平日该利率仅在 2%–3% 区间。其间机构集中融入资金，相互拆借的链条几近停滞，债市与股市同步出现较大波动。这一事件显示：若缺乏明确的"封顶"机制，短端资金利率在市场紧张时可能大幅上行。此后央行逐步完善了**利率走廊**——以常备借贷便利（SLF）利率作为上限，即在机构确有资金需求时，可按该上限价格向央行融资，从而抑制利率过度上行的尾部风险；并以超额准备金利率作为下限。由此可见，利率走廊并非理论上的装饰性安排，而是**对资金面的一项稳定机制**：它使 DR007 等市场利率能够围绕政策中枢平稳波动，降低在流动性紧张时再度大幅偏离的风险。
...
!!! tip "把利率体系和后续章节连起来"
    - DR007 / 回购利率 → 第16章货币市场与套息；
    - LPR / SHIBOR → 第8章浮息债基准；
    - 国债收益率曲线 → 第5章期限结构、第11–13章衍生品定价。
...
运行后将得到一条**向上倾斜**的曲线：短端利率较低、长端利率较高。这是收益率曲线最常见的形态，其背后是期限溢价与对未来利率的预期（第5章详解）。这条曲线即为后续全部定价与风险分析的起点。
...
!!! success "概念题 2"
    四大核心功能与中国例子：① **融资**——财政部发国债、企业发信用债直接募资；② **定价基准**——10 年期国债收益率是房贷、理财、股票估值的锚；③ **流动性管理**——机构用质押式回购、同业存单调剂头寸（第16章）；④ **货币政策传导**——央行通过公开市场操作（7 天逆回购）影响 DR007，再传导到 LPR 与信贷。
...
- 本书用 **uv + akshare/tushare + QuantLib** 搭建可复现环境，复用包 `fi` 贯穿全书；本章已完成第一张收益率曲线的绘制。
