...
骑乘曲线最反直觉、也最迷人的一点是：**它根本不需要你预测利率，只要时间在流逝、曲线维持原状，钱就自己赚出来了。** 想象收益率曲线是一道向上的斜坡，你买入的 5 年期债券是坡上一个较高的点（收益率较高）。一年过去，它自动变成了 4 年期债——但只要整条曲线没动，4 年期对应的收益率本就比 5 年期低，于是你这只债的收益率"顺着斜坡往下滑"了一格，而收益率下降就意味着价格上涨。**你什么都没做，只是让债券随时间沿着那道斜坡往下滚，资本利得就凭空冒了出来**，这就是"roll-down"（下滑）一词的由来；再叠上一路收着的票息（carry），总回报自然跑赢直接持有短债。当然，这份"躺赢"有一个前提条件写在合同的小字里：**曲线得大致不动**。一旦曲线整体大幅上移（利率普涨），下滑带来的那点资本利得会被价格下跌一口吞掉——所以它赚的不是"免费的午餐"，而是"曲线向上倾斜 + 时间流逝 + 曲线稳定"三者叠加给出的、不依赖预测的结构性收益。这也是为什么 17.4 节的收益归因要专门把它从"靠预测赚的钱"里分离出来。
...
为什么这件事如此重要？因为**总收益数字会撒谎，归因不会**。假设两位基金经理今年都赚了 5%，账面上看难分高下。但拆开来看：第一位的 5% 几乎全来自 carry 和 roll-down——也就是说，他只是买入持有、躺着收票息，市场给谁都是这个数，这部分叫 **beta**（市场回报，谁都拿得到）；第二位的 5% 里有 3% 是 carry/roll，另外 2% 来自他精准押对了利率下行、主动拉长久期赚到的——这 2% 才是真正考验判断力、别人未必复制得了的 **alpha**（超额能力）。**前者靠的是运气和市场的馈赠，后者靠的是真本事**，可如果只看"都赚了 5%"，你会把幸运儿误认成股神、把真高手埋没在平庸里。收益归因就是那台诚实的解剖刀，它逼着我们回答一个残酷但必要的问题：**这笔钱，到底是市场赏的，还是你挣的？** 对投资者，它决定该为哪种业绩付管理费；对基金经理自己，它是区分"我真的有能力"还是"我只是赶上了好行情"的唯一照妖镜——而后者，恰恰是许多人最不愿照的镜子。
